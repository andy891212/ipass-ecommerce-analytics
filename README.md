...
### 1. 新客復購率提升機制
* **現狀問題**：新顧客普遍僅消費一次即流失。
* **執行策略**：建立自動化追蹤機制，進行 **「二刷」誘因投放**。
* **具體做法**：
  1. 設定系統自動化觸發條件。
  2. 於顧客首次完成購買後的 **第 2~3 週**，自動發送 **『二刷專屬折價券』**。
  3. 吸引顧客於 **第 2 個月** 回訪並完成第二次消費。

### 2. 行銷預算重分配策略

| 顧客類群 | 策略方向 | 具體執行做法 | 預期效益 |
| :--- | :--- | :--- | :--- |
| **沉睡顧客**<br>*(超過 2 年未消費)* | **停止資源投入** | 立即停止發送 SMS 簡訊與付費廣告推播。 | 大幅降低低效益的行銷支出。 |
| **VIP 顧客**<br>*(高價值重點客戶)* | **資源集中傾斜** | 將省下的行銷預算轉為提供 **尊榮專屬回饋與服務**。 | 提升高價值客群黏著度與貢獻度。 |


> **總結**：停止對低效益沉睡客的無效投放，將資源回饋給核心 VIP，才能最大化整體獲利能力。
---

## 🛠️ 技術架構與資料驗收
* **工具鏈**：MySQL  (數據倉儲/分析) + Python (Data Validation) + Tableau Public (BI 視覺化)
* ** 資料品質查驗**：
...
專案核心結論
---
* Cohort 留存斷崖：熱力圖顯示顧客在首購後第 2 個月  出現極顯著流失。商業解法是在第 14~21 天自動發送二刷優惠，大幅提升二刷率與顧客黏著度。
